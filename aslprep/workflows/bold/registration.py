...
def init_asl_reg_wf(freesurfer, use_bbr, asl2t1w_dof, mem_gb, omp_nthreads,
    ...
    Workflow Graph
        .. workflow::
            ...
            from fmriprep.workflows.asl.registration import init_asl_reg_wf
    ...
    See also
    --------
      * :py:func:`~fmriprep.workflows.asl.registration.init_bbreg_wf`
      * :py:func:`~fmriprep.workflows.asl.registration.init_fsl_bbr_wf`
...
def init_asl_t1_trans_wf(freesurfer, mem_gb, omp_nthreads, multiecho=False, use_fieldwarp=False,
    ...
    Workflow Graph
        .. workflow::
            ...
            from fmriprep.workflows.asl.registration import init_asl_t1_trans_wf
...
def init_bbreg_wf(use_bbr, asl2t1w_dof, omp_nthreads, name='bbreg_wf'):
    """
    ...
    It is a counterpart to :py:func:`~fmriprep.workflows.asl.registration.init_fsl_bbr_wf`,
    ...
    Workflow Graph
        .. workflow ::
            ...
            from fmriprep.workflows.asl.registration import init_bbreg_wf
            wf = init_bbreg_wf(use_bbr=True, asl2t1w_dof=9, omp_nthreads=1)
    ...
    t1w_brain
        Unused (see :py:func:`~fmriprep.workflows.asl.registration.init_fsl_bbr_wf`)
    t1w_dseg
        Unused (see :py:func:`~fmriprep.workflows.asl.registration.init_fsl_bbr_wf`)
...
def init_fsl_bbr_wf(use_bbr, asl2t1w_dof, name='fsl_bbr_wf'):
    ...
    It is a counterpart to :py:func:`~fmriprep.workflows.asl.registration.init_bbreg_wf`,
    ...
    Workflow Graph
        .. workflow ::
            ...
            from fmriprep.workflows.asl.registration import init_fsl_bbr_wf
    ...
    fsnative2t1w_xfm
        Unused (see :py:func:`~fmriprep.workflows.asl.registration.init_bbreg_wf`)
    subjects_dir
        Unused (see :py:func:`~fmriprep.workflows.asl.registration.init_bbreg_wf`)
    subject_id
        Unused (see :py:func:`~fmriprep.workflows.asl.registration.init_bbreg_wf`)
