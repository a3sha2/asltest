...
.. raw:: html
   ...
   function fillCitation(){
      ...
      $('#workflow_url').text('https://aslprep.readthedocs.io/en/' + version + '/workflows.html');
      $('#workflow_url').attr('href', 'https://aslprep.readthedocs.io/en/' + version + '/workflows.html');
   ...
   <p style="font-style: italic;">
     ...
     <a id="workflow_url" href="http://aslprep.readthedocs.io/en/latest/workflows.html">http://aslprep.readthedocs.io/en/latest/workflows.html</a>.
   </p>
   <p>
     1. asl
   </p>
   <p>
     2. <span id="aslprep_citation">ASLPrep</span> Available from: <a id="aslprep_doi_url" > </a>.
